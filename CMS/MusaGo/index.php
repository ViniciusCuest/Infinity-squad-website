...
<body id="body">
               ...
               <tr class="table-row">
                  ...
                  <td>
                     <button type="button" id="openModal">
                        <svg xmlns="http://www.w3.org/2000/svg" style="fill:black; width: 30px"
                  ...
                  <td>
                     <button id="openDeleteModal" type="button" data_disease=<?= $row['cod_doenca'] ?>>
                        <svg style="fill:black; width: 30px" xmlns="http://www.w3.org/2000/svg"
   ...
   <section id="deleteModal"
      style="display: none; background-color: lightgray; position: absolute; width: 450px; height: 250px; border-radius: 8px; left:0; top:0; transform: translate(150%, 150%)">
...
<script>
   $(document).ready(() => {
      ...
      $("#openDeleteModal").click((e) => {
         ...
         $(".deleteModalContainer").css({ display: 'flex' });
      });
